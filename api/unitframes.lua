...
function pfUI.uf:UpdateConfig()
  ...
  f.powerCenterText:SetPoint("TOPLEFT",f.power.bar, "TOPLEFT", 2*(default_border) + f.config.txtpowercenteroffx, 1 + tonumber(f.config.txtpowercenteroffy))
  f.powerCenterText:SetPoint("BOTTOMRIGHT",f.power.bar, "BOTTOMRIGHT", -2*(default_border) + f.config.txtpowercenteroffx, f.config.txtpowercenteroffy)
